...
namespace EAFCMatchTracker.Migrations
{
    ...
    [Migration("20251202202601_CreateGoalLinks")]
    partial class CreateGoalLinks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatchGoalLinkEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SystemFetchAudit", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MatchGoalLinkEntity", b =>
                {
                    ...
                    b.HasOne("PlayerEntity", "PreAssist")
                        .WithMany()
                        .HasForeignKey("PreAssistPlayerEntityId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PlayerEntity", "Scorer")
                        .WithMany()
