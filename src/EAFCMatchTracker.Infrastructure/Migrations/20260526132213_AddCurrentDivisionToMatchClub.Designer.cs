...
namespace EAFCMatchTracker.Migrations
{
    ...
    [Migration("20260526132213_AddCurrentDivisionToMatchClub")]
    partial class AddCurrentDivisionToMatchClub
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EAFCMatchTracker.Domain.Entities.MatchGoalLinkEntity", b =>
                {
                    ...
                    b.Property<long?>("AssistPlayerEntityId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("PreAssistPlayerEntityId")
                        .HasColumnType("bigint");

                    b.Property<long>("ScorerPlayerEntityId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("AssistPlayerEntityId");

                    b.HasIndex("PreAssistPlayerEntityId");

                    b.HasIndex("ScorerPlayerEntityId");

                    b.HasIndex("MatchId", "ClubId");

                    b.ToTable("MatchGoalLinks");
                });

            modelBuilder.Entity("EAFCMatchTracker.Domain.Entities.MatchPlayerEntity", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<short>("Archetypeid")
                        .HasColumnType("smallint");

                    b.Property<short>("Assists")
                        .HasColumnType("smallint");

                    b.Property<short>("BallDiveSaves")
                        .HasColumnType("smallint");
                    ...
                    b.Property<short>("CrossSaves")
                        .HasColumnType("smallint");

                    b.Property<bool>("Disconnected")
                        .HasColumnType("boolean");

                    b.Property<short>("GameTime")
                        .HasColumnType("smallint");
                    ...
                    b.Property<short>("GoodDirectionSaves")
                        .HasColumnType("smallint");
                    ...
                    b.Property<short>("PreAssists")
                        .HasColumnType("smallint");

                    b.Property<int?>("ProHeight")
                        .HasColumnType("integer");

                    b.Property<string>("ProName")
                        .HasColumnType("text");

                    b.Property<int?>("ProOverall")
                        .HasColumnType("integer");

                    b.Property<string>("ProOverallStr")
                        .HasColumnType("text");

                    b.Property<short>("PunchSaves")
                        .HasColumnType("smallint");
                    ...
                    b.Property<short>("SecondsPlayed")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("EAFCMatchTracker.Domain.Entities.PlayerMatchStatsEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EAFCMatchTracker.Domain.Entities.SystemFetchAudit", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EAFCMatchTracker.Domain.Entities.MatchClubEntity", b =>
                {
                    b.HasOne("EAFCMatchTracker.Domain.Entities.MatchEntity", "Match")
                        .WithMany("Clubs")
                        .HasForeignKey("MatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("EAFCMatchTracker.Domain.Entities.ClubDetailsEntity", "Details", b1 =>
                        {
            ...
            modelBuilder.Entity("EAFCMatchTracker.Domain.Entities.MatchGoalLinkEntity", b =>
                {
                    b.HasOne("EAFCMatchTracker.Domain.Entities.PlayerEntity", "Assist")
                        .WithMany()
                        .HasForeignKey("AssistPlayerEntityId")
                    ...
                    b.HasOne("EAFCMatchTracker.Domain.Entities.PlayerEntity", "PreAssist")
                        .WithMany()
                        .HasForeignKey("PreAssistPlayerEntityId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EAFCMatchTracker.Domain.Entities.PlayerEntity", "Scorer")
                        .WithMany()
                        .HasForeignKey("ScorerPlayerEntityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("EAFCMatchTracker.Domain.Entities.MatchPlayerEntity", b =>
                {
                    ...
                    b.HasOne("EAFCMatchTracker.Domain.Entities.PlayerEntity", "Player")
                        .WithMany("MatchPlayers")
